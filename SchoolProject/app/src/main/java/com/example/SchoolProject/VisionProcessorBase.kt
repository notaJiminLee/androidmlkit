...
import com.example.SchoolProject.textdetector.addOnFailureListener
import com.example.SchoolProject.textdetector.addOnSuccessListener
...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
  ...
  override fun processImageProxy(
    ...
    if (!PreferenceUtils.isCameraLiveViewportEnabled(graphicOverlay.context)) {
      val maina : MainActivity = con as MainActivity
      bitmap = con.viewFinder.bitmap
    }
    requestDetectInImage(
      ...
      // may stall.
      .addOnSuccessListener { image.close() }
  }

  // -----------------Common processing logic-------------------------------------------------------
  protected fun requestDetectInImage(
    image: InputImage,
    graphicOverlay: GraphicOverlay,
